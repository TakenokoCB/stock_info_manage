...
export const newsItems: NewsItem[] = [
    ...
    {
        id: 'news-3',
        title: 'NTT、データセンター事業を拡大 AI需要取り込みへ',
        summary: [
            '国内外でデータセンター新設を発表',
            'AI向けGPUサーバー導入を加速',
            '2027年までに投資額を倍増',
    ...
    },
    {
        ...
        sentiment: 'positive',
        relatedAssets: ['NVDA', 'NVIDIA'],
        aiScore: 92,
    },
    {
        id: 'news-5',
        title: 'アップル、Vision Pro 2発表 AI機能を大幅強化',
        summary: [
            '新型XRヘッドセットを2026年後半に発売',
            'オンデバイスAI処理能力が向上',
            '価格は前モデルより20%低下',
        ],
        ...
        sentiment: 'positive',
        relatedAssets: ['AAPL', 'Apple'],
        aiScore: 88,
    },
    {
        id: 'news-6',
        title: 'イーサリアム、ステーキング利回り上昇 注目集める',
        summary: [
            'ネットワーク手数料収入増でステーキング報酬が向上',
            '年利4.5%を超える水準に',
            'DeFi活況が追い風',
        ],
        source: 'CoinPost',
        timestamp: '2026-01-31T18:00:00+09:00',
        sentiment: 'positive',
        relatedAssets: ['ETH', 'イーサリアム'],
        aiScore: 75,
    },
    {
        id: 'news-7',
        title: 'eMAXIS Slim全世界株式、純資産残高5兆円突破',
        summary: [
            '国内最大の投資信託として記録更新',
            '新NISAでの資金流入が継続',
            '月間流入額は3000億円超',
        ...
        source: '投信ウォッチ',
        timestamp: '2026-01-31T15:00:00+09:00',
        sentiment: 'positive',
        relatedAssets: ['eMAXIS', 'オールカントリー'],
        aiScore: 70,
    },
    {
        id: 'news-8',
        title: 'トヨタ、全固体電池量産開始へ 2026年中に試験生産',
        summary: [
            '航続距離1000kmを実現する次世代電池',
            '量産体制は2027年に本格化',
            'EV競争力の大幅強化へ',
        ],
    ...
    {
        id: 'news-9',
        title: 'ビットコインETF、週間流入額が過去最高を更新',
        summary: [
            '機関投資家の参入が加速',
            'ブラックロックのIBIT単体で10億ドル流入',
            '年金基金の採用事例も増加',
        ],
        source: 'Bloomberg',
        timestamp: '2026-01-31T10:00:00+09:00',
        sentiment: 'positive',
        relatedAssets: ['BTC', 'ビットコイン'],
        aiScore: 85,
    },
    {
        id: 'news-10',
        title: 'NVIDIA、新型GPU「Blackwell Ultra」発表',
        summary: [
            'AI学習性能が前世代比2倍に向上',
            '電力効率も大幅に改善',
            '大手クラウドベンダーが早期採用を表明',
        ...
        source: 'CNET Japan',
        timestamp: '2026-01-31T08:00:00+09:00',
        sentiment: 'positive',
        relatedAssets: ['NVDA', 'エヌビディア'],
        aiScore: 94,
    },
    {
        id: 'news-11',
        title: 'NTT、国際通信事業の再編を発表',
        summary: [
            '海外子会社の統合で効率化',
            'グローバルIT事業の収益性改善へ',
            '年間500億円のコスト削減見込む',
        ...
        source: '日経ビジネス',
        timestamp: '2026-01-30T20:00:00+09:00',
        sentiment: 'neutral',
        relatedAssets: ['9432', 'NTT'],
        aiScore: 68,
    },
    {
        id: 'news-12',
        title: 'アップル、インド生産を大幅拡大 サプライチェーン多様化',
        summary: [
            'iPhone生産の25%をインドに移管目標',
            '中国依存度の低減を加速',
            '現地雇用10万人増の見通し',
        ],
        source: 'ロイター',
        timestamp: '2026-01-30T18:00:00+09:00',
        sentiment: 'positive',
        relatedAssets: ['AAPL', 'Apple'],
        aiScore: 76,
    },
    {
        id: 'news-13',
        title: 'イーサリアムL2、取引量が過去最高を更新',
        summary: [
            'Arbitrum・Optimismへの資金流入が加速',
            'メインネット手数料高騰が追い風',
            'DeFi利用者数も増加傾向',
        ],
        source: 'The Block',
        timestamp: '2026-01-30T16:00:00+09:00',
        sentiment: 'positive',
        relatedAssets: ['ETH', 'イーサリアム'],
        aiScore: 72,
    },
    {
        ...
        sentiment: 'positive',
        relatedAssets: ['米国国債', 'BOND'],
        aiScore: 65,
    },
    {
        id: 'news-15',
        title: 'トヨタ、北米向け新型SUV発表 現地生産を強化',
        summary: [
            '2026年秋に新モデル投入',
            'テキサス工場の生産能力を増強',
            'EVおよびハイブリッドモデルを拡充',
    ...
    },
    {
        ...
        source: '日経コンピュータ',
        timestamp: '2026-01-30T08:00:00+09:00',
        sentiment: 'positive',
        relatedAssets: ['9432', 'NTT'],
        aiScore: 74,
    },
    {
        id: 'news-18',
        title: 'NVIDIA、自動車向けAI半導体で新規受注獲得',
        summary: [
            '大手EV メーカーとの契約締結',
            '自動運転向けプラットフォームを提供',
            '2027年から量産車に搭載',
        ...
        source: 'Nikkei Asia',
        timestamp: '2026-01-29T20:00:00+09:00',
        sentiment: 'positive',
        relatedAssets: ['NVDA', 'エヌビディア'],
        aiScore: 86,
    },
    {
        id: 'news-19',
        title: 'アップル、App Store手数料見直し EU規制対応',
        summary: [
            'サードパーティ決済を一部認可',
            '手数料率を段階的に引き下げ',
            '売上への影響は限定的との見方',
        ...
        source: 'TechCrunch Japan',
        timestamp: '2026-01-29T18:00:00+09:00',
        sentiment: 'neutral',
        relatedAssets: ['AAPL', 'Apple'],
        aiScore: 62,
    },
    {
        ...
        source: '投信ウォッチ',
        timestamp: '2026-01-29T16:00:00+09:00',
        sentiment: 'positive',
        relatedAssets: ['eMAXIS', '楽天・オールカントリー'],
        aiScore: 68,
    },
    {
        id: 'news-21',
        title: 'イーサリアム財団、次期アップグレード計画を発表',
        summary: [
            'シャーディング実装でスケーラビリティ向上',
            '2026年後半の実装を目標',
            '手数料のさらなる低減を期待',
        ],
        source: 'CoinPost',
